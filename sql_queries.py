...
songplay_table_create = (" CREATE TABLE IF NOT EXISTS songplays(songplay_id SERIAL, start_time numeric, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id varchar, location varchar, user_agent varchar)")
...
user_table_insert = ("""
                        ...
                        VALUES (%s, %s, %s, %s, %s DO UPDATE SET level = EXCLUDED.level)
""")
